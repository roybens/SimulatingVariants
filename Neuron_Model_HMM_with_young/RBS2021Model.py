...
init_settings()
mechs = ['na12A','na12N','na12A_Mut','na12N_Mut','na16']
WT_fn = './Params/na12WT.txt'
#update_mechs_props(WT_fn,mechs)
#vshift_values = [-30,19,20]
...
#gbar_values = [0.1,2,2.1]
#explore_param(mechs,'gbar',gbar_values)
#ah_values = [0.1,100]
#explore_param(mechs,'ahfactor',ah_values)
#bh_values = [0.1,100]
#explore_param(mechs,'bhfactor',bh_values)

init_stim(amp=0.2)
Vm, I, t, stim = run_model()
plot_stim_volts_pair(Vm, 'Step Stim 200pA', file_path_to_save='./Plots/WTHMM_200pA',times=t)
#init_stim(amp=0.5)
#Vm, I, t, stim = run_model()
