###################################################################
#### Important na12mut8st helper functions for the evaluators. ####
#### Authors: Michael Lam, Jinan Jiang ############################
## AS OF 12/28/2021, ONLY THE find_tau0 FUNCTION HAS BEEN #########
...
def find_tau0(upper = 700, make_plot = False, color = 'red'):
    ...
    act = ggsdHMM.Activation(channel_name = 'na12mut8st')
    act.clamp_at_volt(0)
