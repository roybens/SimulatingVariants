...
class Vclamp_evaluator(bpop.evaluators.Evaluator):
    ...
    def __init__(self, scaled):
        ...
        ssi_slope, v_half, top, bottom, tau0 = cf.calc_inact_obj("na12", is_HMM=False)
...
offspring_size = 1500
num_generations = 300
output_log_file_name = 'jinan_na12_fitting_I1640NAdult_2.txt'
param_range_file = "./csv_files/param_stats_wide_na12.csv"
mutant_name = "I1640NAdult"
mutant_protocol_csv_name = './csv_files/mutant_protocols_CHOP.csv'
initial_baseline_parameters = eh12.get_wt_params_adultWT()
...
offspring_size = 1500
num_generations = 300
output_log_file_name = 'jinan_na12_fitting_m1770LAdult_2.txt'
param_range_file = "./csv_files/param_stats_wide_na12.csv"
