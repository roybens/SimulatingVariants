########################################################
#### Important na12 helper functions for the evaluators. ####
...
def get_currh_params_str():
    ...
    """
    param_list_str = ['currh.sh_na12', 'currh.tha_na12', 'currh.qa_na12', 'currh.Ra_na12', 'currh.Rb_na12', 'currh.thi1_na12', 'currh.thi2_na12', 'currh.qd_na12', 'currh.qg_na12', 'currh.mmin_na12', 'currh.hmin_na12', 'currh.q10_na12', 'currh.Rg_na12', 'currh.Rd_na12', 'currh.qq_na12', 'currh.tq_na12', 'currh.thinf_na12', 'currh.qinf_na12', 'currh.vhalfs_na12', 'currh.a0s_na12', 'currh.zetas_na12', 'currh.gms_na12', 'currh.smax_na12', 'currh.vvh_na12', 'currh.vvs_na12', 'currh.Ena_na12']
...
def make_act_plots(new_params, param_values_wt = wt_params, filename = 'jinan_plots_out.pdf'):
    ...
    ############################################################################################################
    goal_dict = read_mutant_protocols('./csv_files/mutant_protocols.csv', 'na12_MUT')
    print("(actual, goal)")
