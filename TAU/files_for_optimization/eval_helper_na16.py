...
global currh
def set_channel(channel_suffix = 'na16'):
    global currh
...
def set_param(param_values):
    ...
    currh.Ena_na16 = param_values[23] #we don't want to change Ena...
    currh.Ena_na16 = 55
...
def change_params(new_params, scaled=False, is_HMM=False):
    '''
    Change params on na16mut channel in NEURON.
    ---
