...
def read_mutant_protocols(mutant_protocols_csv, mutant):
    ...
    protocols_dict = {}  # 0 for additive, 100 for multiplicative, see scoring fn relative  # changed.
    protocols_dict['dv_half_act'] = 0
    protocols_dict['gv_slope'] = 100
    protocols_dict['dv_half_ssi'] = 0
    protocols_dict['ssi_slope'] = 100
    protocols_dict['tau_fast'] = 100
    protocols_dict['tau_slow'] = 100
    protocols_dict['percent_fast'] = 100
    protocols_dict['udb20'] = -1
    protocols_dict['tau0'] = 100
    protocols_dict['ramp'] = -1
    protocols_dict['persistent'] = -1
