...
class Vclamp_evaluator_HMM(bpop.evaluators.Evaluator):
    ...
    def initialize_wild_data(self):
        ...
        gv_slope, v_half_act, top, bottom = cf.calc_act_obj(is_HMM)
        ssi_slope, v_half_inact, top, bottom, tau0 = cf.calc_inact_obj(is_HMM)
        y0, plateau, percent_fast, k_fast, k_slow = cf.calc_recov_obj(is_HMM)
